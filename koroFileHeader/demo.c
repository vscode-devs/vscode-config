 ...
 * @brief  lcd_drawline()
 * @note   画线函数
 * @param  [in] x1		: 线起始点坐标X轴
 * @param  [in] y1		: 线起始点坐标Y轴
 * @param  [in] x2		: 线终止点坐标X轴
 * @param  [in] y2		: 线终止点坐标Y轴
 * @param  [out]
 * @retval 
 */
 ...
 * @note   画矩形函数
 * @param  [in] x1	: 矩形坐上角坐标X轴
 * @param  [in] y1	: 矩形坐上角坐标Y轴
 * @param  [in] x2	: 矩形右下角坐标X轴
 * @param  [in] y2	: 矩形右下角坐标Y轴
 * @param  [out]
 * @retval 
 */
 ...
 * @param  [in] y	: 起始坐标Y轴
 * @param  [in] num	: 显示字符
 * @param  [in] size: 字体大小, 可选12/16/24/32
 * @param  [in] mode: 叠加方式(1)还是非叠加方式(0)
 * @param  [out]
 * @retval 
 */
...
/**
 * @brief  lcd_shownum()
 * @note   显示指定的数字，高位为0的话不显示
 * @param  [in] x	: 起始坐标点X轴。
 * @param  [in] y	: 起始坐标点Y轴。
 * @param  [in] num	: 数值(0~999999999)。
 * @param  [in] len : 数字位数。
 * @param  [in] size: 字体大小
 * @param  [out]
 * @retval 
...
/**
 * @brief  lcd_showxnum()
 * @note   显示指定的数字，高位为0,还是显示
 * @param  [in] x	 	: 起始坐标点X轴。
 * @param  [in] y	 	: 起始坐标点Y轴。
 * @param  [in] num		: 数值(0~999999999)。
 * @param  [in] len 	: 数字位数。
 * @param  [in] size	: 字体大小
 * @param  [in] mode	: [7]:0,不填充;1,填充0.
 * 					      [6:1]:保留
 *					      [0]:0,非叠加显示;1,叠加显示.
 * @param  [out]
 * @retval 
...
/**
 * @brief  lcd_show_string()
 * @note   显示一串字符串
 * @param  [in] x		: 起始坐标点X轴。
 * @param  [in] y		: 起始坐标点Y轴。
 * @param  [in] width 	: 字符串显示区域长度
 * @param  [in] height	: 字符串显示区域高度
 * @param  [in] size	: 字体大小
 * @param  [in] p		: 要显示的字符串首地址
 * @param  [out]
 * @retval 
 */
